...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Raphael Mateman
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home_subtitle">Digital Creator</h3>
        <p className="home_description">Hi, I'm Raphael a web designer,
        passionate about making useful, solid and usable projects</p>
